...
public class BlogDaoImpl implements BlogDAO {
    ...
    private static final String SQL_SELECT_ALL_PUBLISHED_BLOGPOSTS_BY_CATEGORY
            ...
            + "WHERE category = ? AND expiry_date >= CURDATE() AND publish_date <= CURDATE() order by publish_date desc";

    private static final String SQL_SELECT_ALL_PUBLISHED_BLOGPOSTS
            = "SELECT * FROM blog_post WHERE publish_date <= CURDATE() AND expiry_date >= CURDATE() order by publish_date desc";
